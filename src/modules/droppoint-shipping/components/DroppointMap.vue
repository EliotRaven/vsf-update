  ...
  <div class="droppoint-map">
    <div class="col-sm-12 mb25">
      <div class="row">
        ...
        <div class="col-sm-6">
          <label class="form-label">Улица, метро</label>
    ...
    <div class="col-sm-12">
      <div class="nav-wrapper">
        <div class="row">
          <div class="col-sm-6">
            <a href="#" @click.prevent="show = false" :class="[{'active': !show}, 'tab-nav']">Список</a>
          </div>
          <div class="col-sm-6">
            <a href="#" @click.prevent="show = true" :class="[{'active': show}, 'tab-nav']">Карта</a>
          </div>
        </div>
      </div>
    </div>
