<template>
  <div id="home">
    ...
    <collection :title="$t('Offer of the month')" cover-image="/assets/collection.jpg" category="Women"/>
    <collection :title="$t('Popular goods')" cover-image="/assets/collection.jpg" category="Man"/>
    <collection :title="$t('Sale')" cover-image="/assets/collection.jpg" category="Gear"/>
...
import FirstBlock from 'theme/components/core/FirstBlock'
