<template>
  ...
  >
    ...
    >
      ...
      <span
        class="price-original mr5 lh30 cl-accent"
...
import { ProductTileHome } from '@vue-storefront/core/modules/catalog/components/ProductTileHome.ts'

export default {
  mixins: [ProductTileHome],
  props: {
    labelsActive: {
      type: Boolean,
      requred: false,
