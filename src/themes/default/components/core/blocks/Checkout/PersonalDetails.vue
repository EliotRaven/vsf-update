  ...
  <div class="personal-details">
    <div class="row pl20">
      <div class="col-xs-1 col-sm-2 col-md-1">
        <div class="number-circle lh35 cl-white brdr-circle align-center weight-700"
    ...
    <div class="row pl20" v-if="isActive">
      ...
      <div class="col-xs-11 col-sm-9 col-md-10">
        <div class="row">
          <base-input class="col-xs-12 col-md-6 mb25"
                      type="text"
                      :autofocus="true"
                      name="first-name"
          ...
          <base-input class="col-xs-12 mb25"
                      type="email"
                      name="email-address"
          ...
          <base-checkbox class="col-xs-12 mb15"
                         v-if="!currentUser"
          ...
          <template v-if="createAccount && !currentUser">
            <base-input class="col-xs-12 mb25 mt10"
                        type="password"
                        name="password"
                        ref="password"
            ...
            >
              {{ $t('I accept ') }}
              <span class="link pointer" @click.prevent="$bus.$emit('modal-toggle', 'modal-terms')">
      ...
      <div class="col-xs-11 col-sm-9 col-md-10">
        <div class="row my30">
          <div class="col-xs-12 col-md-7 px20 button-container">
            <button-full data-testid="personalDetailsSubmit"
