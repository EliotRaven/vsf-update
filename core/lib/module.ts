...
export interface VueStorefrontModuleConfig {
  key: string;
  store?: { modules?: { key: string, module: Module<any, any> }[], plugin?: any };
  router?: { routes?: RouteConfig[], beforeEach?: NavigationGuard, afterEach?: NavigationGuard },
  beforeRegistration?: (Vue?: VueConstructor, config?: any, store?: Store<RootState>, isServer?: boolean,) => void,
  afterRegistration?: (Vue?: any, config?: any, store?: any, isServer?: boolean) => void,
}
